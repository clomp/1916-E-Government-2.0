...
Für jedermann sollte [...] ein Zugang zu jenen Daten der Verwaltung frei gegeben werden, die keinen Datenschutz-
oder Sicherheitsbeschränkungen unterliegen."  Jörg von Lucke in "Open Government, Öffnung von Staat und Verwaltung"
\end{definiere}}
...
\end{kasten}
\begin{kasten}
 Fehlen einer Open Data Lizenz  (wie z.B. in GroßBritanien)
\end{kasten}}
...
\begin{itemize}
  ...
  \item Informationsgehalt stark abhängig von Zielen und Adressaten der Visualisierung
\end{itemize}
\end{merkmale}
}
...
\begin{itemize}
  \item Erstellung neuer Inhalte durch Kombination bereits verfügbarer (oft über APIs)
  \item Häufig Verwendung von Karten oder Darstellung von Beziehungen
...
\begin{itemize}
  ...
  \item Daten verschiedenen Detailgrades sollen sich nahtlos zusammenfügen
  \item Daten sollen leicht auffindbar und transparent zur Verfügung stehen 
 \end{itemize}
\end{merkmale}}
...
Ziele:
  \begin{itemize}
    ...
    \item Zugang zu allen Geodaten, die für Regierungsentscheidungen notwendig sind
  \end{itemize}
\end{merkmale}}
